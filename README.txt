...
Results can be found in the Censuses folder.  We provide monodromys as words in
a generating set for the mapping class group of the surface. In many cases this
is the standard surface file that is included in Twister.  For example, as the
word aBCx appears in the S_1_2 census this manifold can be built in SnapPy by
doing:
